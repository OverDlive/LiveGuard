...
public class RecommendationOnboardingAdapter extends RecyclerView.Adapter<RecommendationOnboardingAdapter.RecommendationViewHolder> {
    ...
    public RecommendationOnboardingAdapter(Context context, List<Integer> pageLayouts, ChoiceListener listener) {
            ...
            if (position == 0) {
                ...
                if (startButton != null) {
                    startButton.setOnClickListener(v -> {
                        ((RecommendationOnboardingActivity) context).moveToNextPage();
                    });
                }
            } else {
                for (int i = 1; i <= 4; i++) {
