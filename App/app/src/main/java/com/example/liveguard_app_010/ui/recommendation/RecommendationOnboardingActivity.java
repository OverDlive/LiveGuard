package com.example.liveguard_app_010.ui.recommendation;
...
public class RecommendationOnboardingActivity extends AppCompatActivity {

    private ViewPager2 viewPager;
    private Button analyzeButton;
    private boolean[] selectionCompleted = new boolean[]{false, false, false, false};
    private List<Integer> recommendationPages;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recommendationPages = Arrays.asList(
                R.layout.recommendation_intro_page,
                R.layout.recommendation_choice_page_1,
                R.layout.recommendation_choice_page_2,
                R.layout.recommendation_choice_page_3,
                R.layout.recommendation_choice_final_page
        );

        RecommendationOnboardingAdapter adapter = new RecommendationOnboardingAdapter(this, recommendationPages, new RecommendationOnboardingAdapter.ChoiceListener() {
            @Override
    ...
    private void moveToResult() {
        Intent intent = new Intent(RecommendationOnboardingActivity.this, TourResultActivity.class);
