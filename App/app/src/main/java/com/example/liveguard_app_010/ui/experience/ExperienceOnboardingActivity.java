...
public class ExperienceOnboardingActivity extends AppCompatActivity {

    private ViewPager2 viewPager;
    private Button analyzeButton;
    private boolean[] selectionCompleted = new boolean[]{false, false, false, false};
    private List<Integer> experiencePages;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_experience_onboarding);
        ...
        experiencePages = Arrays.asList(
                R.layout.experience_intro_page,
                R.layout.experience_choice_page_1,
                R.layout.experience_choice_page_2,
                R.layout.experience_choice_page_3,
                R.layout.experience_choice_final_page
        );

        ExperienceOnboardingAdapter adapter = new ExperienceOnboardingAdapter(this, experiencePages, new ExperienceOnboardingAdapter.ChoiceListener() {
            @Override
    ...
    private void moveToResult() {
        Intent intent = new Intent(ExperienceOnboardingActivity.this, TourResultActivity.class);
