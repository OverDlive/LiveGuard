...
/**
 * XML <row> 하나의 청소년 수련시설 프로그램 정보를 나타내는 모델 클래스
 */
@Root(name = "row", strict = false)
public class YouthTrainingFacilityData implements Serializable {
    ...
    // Coordinate fields from location API
    ...
    // 기본 생성자 (Simple XML 요구)
    public YouthTrainingFacilityData() {}

    // Getter & Setter
    public String getUpId() { return upId; }
    public void setUpId(String upId) { this.upId = upId; }

    public String getUpNm() { return upNm; }
    public void setUpNm(String upNm) { this.upNm = upNm; }

    public String getSaleComCd() { return saleComCd; }
    public void setSaleComCd(String saleComCd) { this.saleComCd = saleComCd; }

    public String getSaleComNm() { return saleComNm; }
    public void setSaleComNm(String saleComNm) { this.saleComNm = saleComNm; }

    public String getBasCd() { return basCd; }
    public void setBasCd(String basCd) { this.basCd = basCd; }

    public String getBasNm() { return basNm; }
    public void setBasNm(String basNm) { this.basNm = basNm; }
    ...
    public String getClsCd() { return clsCd; }
    public void setClsCd(String clsCd) { this.clsCd = clsCd; }

    public String getClsNm() { return clsNm; }
    public void setClsNm(String clsNm) { this.clsNm = clsNm; }

    public String getPgmCd() { return pgmCd; }
    public void setPgmCd(String pgmCd) { this.pgmCd = pgmCd; }

    public String getPgmNm() { return pgmNm; }
    public void setPgmNm(String pgmNm) { this.pgmNm = pgmNm; }

    public String getFgCd() { return fgCd; }
    public void setFgCd(String fgCd) { this.fgCd = fgCd; }

    public String getFgNm() { return fgNm; }
    public void setFgNm(String fgNm) { this.fgNm = fgNm; }

    public String getYymm() { return yymm; }
    public void setYymm(String yymm) { this.yymm = yymm; }

    public String getTargetCd() { return targetCd; }
    public void setTargetCd(String targetCd) { this.targetCd = targetCd; }

    public String getTargetNm() { return targetNm; }
    public void setTargetNm(String targetNm) { this.targetNm = targetNm; }

    public String getMmQty() { return mmQty; }
    public void setMmQty(String mmQty) { this.mmQty = mmQty; }

    public String getStartT() { return startT; }
    public void setStartT(String startT) { this.startT = startT; }
    ...
    public String getUPrice() { return uPrice; }
    public void setUPrice(String uPrice) { this.uPrice = uPrice; }

    public String getStartDay() { return startDay; }
    public void setStartDay(String startDay) { this.startDay = startDay; }

    public String getRealStDt() { return realStDt; }
    public void setRealStDt(String realStDt) { this.realStDt = realStDt; }

    public String getRealEdDt() { return realEdDt; }
    public void setRealEdDt(String realEdDt) { this.realEdDt = realEdDt; }

    public String getDtWeekCd() { return dtWeekCd; }
    public void setDtWeekCd(String dtWeekCd) { this.dtWeekCd = dtWeekCd; }

    public String getRglQty() { return rglQty; }
    public void setRglQty(String rglQty) { this.rglQty = rglQty; }
