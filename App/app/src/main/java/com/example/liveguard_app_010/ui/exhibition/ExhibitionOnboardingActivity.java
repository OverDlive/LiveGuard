...
public class ExhibitionOnboardingActivity extends AppCompatActivity {

    private ViewPager2 viewPager;
    private Button analyzeButton;
    private boolean[] selectionCompleted = new boolean[]{false, false, false, false};
    private List<Integer> exhibitionPages;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exhibition_onboarding);

        viewPager = findViewById(R.id.viewPager);
        analyzeButton = findViewById(R.id.btn_analyze);

        exhibitionPages = Arrays.asList(
                R.layout.exhibition_intro_page,
                R.layout.exhibition_choice_page_1,
                R.layout.exhibition_choice_page_2,
                R.layout.exhibition_choice_page_3,
                R.layout.exhibition_choice_final_page
        );

        ExhibitionOnboardingAdapter adapter = new ExhibitionOnboardingAdapter(this, exhibitionPages, new ExhibitionOnboardingAdapter.ChoiceListener() {
            @Override
    ...
    private void moveToResult() {
        Intent intent = new Intent(ExhibitionOnboardingActivity.this, TourResultActivity.class);
